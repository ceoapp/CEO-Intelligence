                  ...
                  <div className="mt-16 pt-8 border-t border-gray-100">
                    <div className="flex items-start gap-3 max-w-4xl mx-auto">
                        ...
                        <div className="text-sm text-gray-900 font-normal leading-relaxed space-y-3">
                            <p>
                                <strong>Disclaimer:</strong> เนื้อหาทั้งหมดถูกสร้างและเรียบเรียงโดย Generative AI เป็นการวิเคราะห์และนำเสนอข้อมูลเชิงสังเคราะห์ ไม่ใช่ข้อเท็จจริง ที่ผ่านการตรวจสอบโดยมนุษย์
                            </p>
                            <div className="space-y-1">
                                <p><strong>1. ความเสี่ยงด้านข้อมูล:</strong> เทคโนโลยีนี้มีข้อจำกัดที่เรียกว่า "Hallucination" ซึ่งอาจนำไปสู่ข้อความที่ผิดพลาดหรือบิดเบือนไปจากความเป็นจริงได้</p>
